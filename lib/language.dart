...
class AppStrings{
  ...
  static void initialize(){
    ...
    _languages.addAll({_supportedLanguages[0]: LanguagePack(
      ...
      api_loadingScreenHintFriendly4_Universal: 'Áramszünet van a Neptun szervertermében...',
      api_loadingScreenHintFriendly5_Universal: 'A Neptun szerverei éppen kávészünetet tartanak...',
      api_loadingScreenHintFriendly6_Universal: 'Tudtad? Az alapjául szolgáló "Neptun 2" csupán 1 hét alatt készült...',
      api_loadingScreenHintFriendly7_Universal: 'Túl lassú? Sajnos ezen az NHNK nem tud segíteni...',
      api_loadingScreenHint1_Universal: 'Úgy dolgoznak a Neptun szerverek, mint egy átlagos államilag finanszírozott útépítés...',
      api_loadingScreenHint2_Universal: 'Ennyi idő alatt kézzel is kiszámoltad volna az átlagodat...',
      ...
      api_loadingScreenHint6_Universal: 'Hivatalos mobilapp helyett kaptunk egy weboldalt, ami mobilon is megnyílik...',
      ...
      topheader_subjects_CreditsInSemester: 'Kredited ebben a félévben: %0',
      ...
      topheader_periods_MainHeader: '%0 %1, %2 %3, %4 %5',
      ...
      popup_case5_ExamInfo: 'Vizsga Infó',
      ...
      popup_case8_AcceptLanguageSuggestion: 'App Nyelvezet',
    ...
    _languages.addAll({_supportedLanguages[1]: LanguagePack(
      ...
      api_loadingScreenHintFriendly4_Universal: 'There\'s a power outage in the Neptun server room...',
      api_loadingScreenHintFriendly5_Universal: 'The Neptun servers are taking a coffee break...',
      api_loadingScreenHintFriendly6_Universal: 'Did you know? "Neptun 2", the project this is based on, was created in about 1 week...',
      api_loadingScreenHintFriendly7_Universal: 'Too slow? Sadly this one is out of NHNK\'s hands...',
      api_loadingScreenHint1_Universal: 'The Neptun servers are working as hard as an average publicly funded road project...',
      api_loadingScreenHint2_Universal: 'You could have worked out your average by hand in this time...',
      api_loadingScreenHint3_Universal: 'Be patient, the servers are down because a rat got into them...',
      api_loadingScreenHint4_Universal: 'I\'m more likely to believe there are penguins at the North Pole than that anyone has spent money on the Neptun servers...',
      api_loadingScreenHint5_Universal: 'Neptun servers are so reliable, I would do my banking on them...',
      api_loadingScreenHint6_Universal: 'Instead of an official mobile app, we got a website that also opens on a phone...',
      ...
      topheader_subjects_CreditsInSemester: 'Your credits this semester: %0',
      ...
      popup_case5_ExamInfo: 'Exam Info',
      ...
      popup_case8_AcceptLanguageSuggestion: 'App Language',
