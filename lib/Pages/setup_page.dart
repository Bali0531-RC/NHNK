            ...
            Center(
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      const SizedBox(height: 20),
                      // Alternative to step 3, so it shows the same position in the flow.
                      const Padding(
                        padding: EdgeInsets.fromLTRB(10, 0, 10, 24),
                        child: OnboardingStepBar(step: 3, total: 4),
                      ),
                      Text(
              ...
              child: SingleChildScrollView(
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      const SizedBox(height: 20),
                      // Last step of the onboarding flow, so it carries the same bar.
                      const Padding(
                        padding: EdgeInsets.fromLTRB(10, 0, 10, 24),
                        child: OnboardingStepBar(step: 4, total: 4),
                      ),
                      Text(
